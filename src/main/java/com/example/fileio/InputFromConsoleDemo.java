...
public class InputFromConsoleDemo {
	 ...
	 * 
	 * String name = in.nextLine(); System.out.println("Input name: " + name);
	 * 
	 * int age = in.nextInt(); System.out.println("Input age: " + age);
	 * 
	 * String employer = in.next(); System.out.println("INput employer: " +
	 * employer); }
	 */
